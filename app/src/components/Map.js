...
import MapView, {Marker, PROVIDER_GOOGLE} from 'react-native-maps-osmdroid';
...
class map extends React.Component {
  ...
  renderMarker = (marker,key) => {
    ...
    return (
      <Marker image = {img  } rotation={angle+65+180} key={Math.random().toString()} coordinate={{latitude: parseFloat(coords.lat), longitude: parseFloat(coords.lng)}} />
